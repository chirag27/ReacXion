...
//NOTE: You must send 64 color values to the RGB matrix before it displays an idist5!
...
//Follow your hand!
int follow_hand (char color, int limit, int previous)
{
  int val;
  sense_update();
  if (dist1>limit) val=1;
  else if (dist2>limit) val=2;
  else if (dist3>limit) val=3;
  else if (dist4>limit) val=4;
  else if (dist5>limit) val=5;

  if (val != previous) pattern_all_on(BLACK);
  if      (val == 1) arrow1(color);
  else if (val == 2) arrow2(color);
  else if (val == 3) arrow3(color);
  else if (val == 4) arrow4(color);
  else if (val == 5) arrow5(color);
  
  return val;
}

//Arrow Patterns
void arrow1 (char color)
{
  send_colors(CS_LED1, color_buffer1);
  send_colors(CS_LED2, color_buffer2);
...
void pattern_multisquares(char colorA, char colorB, char colorC, char colorD, char colorE, char defaultColor)
{
  
  sense_update();
  if      (dist1 < 30)  pattern_square1(defaultColor);
  else if (dist1 < 60)  pattern_square2(colorA);
  else if (dist1 < 90)  pattern_square3(colorA);
  else if (dist1 < 120) pattern_square4(colorA);
  else if (dist1 < 150) pattern_square5(colorA);
  else if (dist1 < 180) pattern_square6(colorA);
  else if (dist1 < 210) pattern_square7(colorA);
  else if (dist1 < 240) pattern_square8(colorA);
  
  sense_update();
  if      (dist2 < 30)  pattern_square1(defaultColor);
  else if (dist2 < 60)  pattern_square2(colorB);
  else if (dist2 < 90)  pattern_square3(colorB);
  else if (dist2 < 120) pattern_square4(colorB);
  else if (dist2 < 150) pattern_square5(colorB);
  else if (dist2 < 180) pattern_square6(colorB);
  else if (dist2 < 210) pattern_square7(colorB);
  else if (dist2 < 240) pattern_square8(colorB);
  
  sense_update();
  if      (dist3 < 30)  pattern_square1(defaultColor);
  else if (dist3 < 60)  pattern_square2(colorC);
  else if (dist3 < 90)  pattern_square3(colorC);
  else if (dist3 < 120) pattern_square4(colorC);
  else if (dist3 < 150) pattern_square5(colorC);
  else if (dist3 < 180) pattern_square6(colorC);
  else if (dist3 < 210) pattern_square7(colorC);
  else if (dist3 < 240) pattern_square8(colorC);
  
  sense_update();
  if      (dist4 < 30)  pattern_square1(defaultColor);
  else if (dist4 < 60)  pattern_square2(colorD);
  else if (dist4 < 90)  pattern_square3(colorD);
  else if (dist4 < 120) pattern_square4(colorD);
  else if (dist4 < 150) pattern_square5(colorD);
  else if (dist4 < 180) pattern_square6(colorD);
  else if (dist4 < 210) pattern_square7(colorD);
  else if (dist4 < 240) pattern_square8(colorD);
  
  sense_update();
  if      (dist5 < 30)  pattern_square1(defaultColor);
  else if (dist5 < 60)  pattern_square2(colorE);
  else if (dist5 < 90)  pattern_square3(colorE);
  else if (dist5 < 120) pattern_square4(colorE);
  else if (dist5 < 150) pattern_square5(colorE);
  else if (dist5 < 180) pattern_square6(colorE);
  else if (dist5 < 210) pattern_square7(colorE);
  else if (dist5 < 240) pattern_square8(colorE); 
}
